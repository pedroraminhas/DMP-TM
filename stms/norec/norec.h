...
#  define norec_SIGLONGJMP(env, val)		siglongjmp(env, val); assert(0)
...
void	 norec_Atomic_Inc_Clock      ();

intptr_t norec_TxLoad_inner        (norec_Thread*, volatile intptr_t*);
extern inline intptr_t norec_TxLoad        (norec_Thread*, volatile intptr_t*);
...
extern inline void     norec_TxStore       (norec_Thread*, volatile intptr_t*, intptr_t);
