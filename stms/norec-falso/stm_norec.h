...
#define norec_STM_READ_F(var)                 norec_IP2F(norec_TxLoad(norec_STM_SELF, \
                                                    (vintp*)norec_FP2IPP(&(var))))
...
#define norec_STM_WRITE(var, val)             norec_TxStore(norec_STM_SELF, \
                                                (vintp*)(void*)&(var), \
                                                (intptr_t)(val))
#define norec_STM_WRITE_F(var, val)           norec_TxStore(norec_STM_SELF, \
                                                (vintp*)norec_FP2IPP(&(var)), \
                                                norec_F2IP(val))
...
#define norec_HTM_IS_LOCKED()			norec_IsLocked()
#define norec_HTM_ATOMIC_INC_CLOCK()		norec_Atomic_Inc_Clock()
#endif /* STM_H */
