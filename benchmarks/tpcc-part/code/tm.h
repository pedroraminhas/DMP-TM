                            ...
                            break; \
                            		...
                            		if (__TM_is_footprint_exceeded(&TM_buff)) { \
                                        ...
                                        if(!bailout){ \
                            				...
                            				if(temp>10 && (sched_capacity[num_tx].counter * 100/ temp) >= sched_threshold){ \
...
#  define SLOW_PATH_SHARED_WRITE_D(var, val)   stm_store_double((volatile double *)(void *)&(var), val)s
