...
extern __attribute__((aligned(CACHE_LINE_SIZE))) padded_float_t* balances;
extern __attribute__((aligned(CACHE_LINE_SIZE))) padded_float_t* client_balances;
extern __attribute__((aligned(CACHE_LINE_SIZE))) padded_scalar_t* client_balances_cnt;
extern __attribute__((aligned(CACHE_LINE_SIZE))) padded_scalar_t* client_delivery_cnt;
extern __attribute__((aligned(CACHE_LINE_SIZE))) padded_float_t* district_balances;
extern __attribute__((aligned(CACHE_LINE_SIZE))) padded_float_t* customer_balances;
